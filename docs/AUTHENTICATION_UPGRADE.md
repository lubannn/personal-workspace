...
> 状态：GitHub App OAuth 已上线；四设备登录、刷新、读写、当前设备退出与全部设备撤销验收全部通过
> 版本：0.2
> 日期：2026-08-27
...
四设备核心流程均通过。随后完成当前设备退出、重新登录和全部设备撤销：有效
会话先从 5 降至 4，重新登录后恢复为 5，最终全部撤销后为 0；D1 保留 8 条
已撤销历史记录用于审计。步骤 1 至 8 至此全部完成，PAT 仅作为高级回退入口。
