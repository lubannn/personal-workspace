    ...
    <section className="portability-card" aria-labelledby="portability-title">
      ...
      <div className="portability-grid">
        <article>
          ...
          <p>读取 workspace.json、Dashboard 布局、全部 Capture、Task、Project、阶段、里程碑、Project Note、文件引用、Activity 和 Calendar Event，生成带 SHA-256、Git blob SHA、文件数量与 schema 版本的 JSON。</p>
