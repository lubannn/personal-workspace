    ...
    <section className="portability-card" aria-labelledby="portability-title">
      ...
      <div className="portability-grid">
        <article>
          ...
          <p>读取 workspace.json、Dashboard 布局和全部 canonical collection（含 ReportDraft 及其事实快照），生成带 SHA-256、Git blob SHA、文件数量与 schema 版本的 JSON。</p>
