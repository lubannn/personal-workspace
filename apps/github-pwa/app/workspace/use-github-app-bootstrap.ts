...
export function useGitHubAppBootstrap(options: Options) {
  ...
  useEffect(() => {
    ...
    void bootstrap();
  }, [adapterRef, loadActivityEvents, loadCalendarEvents, loadDashboardLayout, loadJournalEntries, loadJournalImportCheckpoints, loadJournalRevisions, loadJournalSegments, loadMilestones, loadProjectFileReferences, loadProjectNotes, loadProjectPhases, loadProjects, loadRecentCaptures, loadReportDrafts, loadTasks, loadTimeEntries, setAuthAvailability, setConnecting, setConnection, setConnectionMethod, setErrorMessage, setStatusMessage]);
}
